    ...
    for (step = 0; step < 1; step++) {
        ...
        while (s < 5) {
            ...
            for (k1 = 0; k1 < 100/*100*/ && restart != rc; k1++) {         // message passing, for predetermined threshold = 100
                ...
                for (i = 0; i < rc; i++) {
                    ...
                    if (i < (rc/2)) {
                        for (m = 0; m < 12; m++) {
                            comput[L1[i][m] - 1] += 1;
                            /*if ((L1[i][m] - 1 )== 9871 ) {
                                printf("L1 = %d ", L1[i][m] - 1);
                                printf("comput[9871] = %d ", comput[L1[i][m] - 1]);
                            }*/
                        }
                    } else if (i >=(rc/2) && i < 4319) {
                        for (m = 0; m < 5; m++) {
                            comput[L2[i-2468][m] - 1] += 1;
                            /*if ((L2[i-2468][m] - 1 )== 9871 ){
                                printf("L2 = %d ", L2[i-2468][m] - 1);
                                printf("comput[9871] = %d ", comput[L2[i-2468][m] - 1]);
                            }*/
                        }
                    } else {
                        for (m = 0; m < 6; m++) {
                            comput[L3[i-4319][m] - 1] += 1;
                            /*if ((L3[i-4319][m] - 1 )== 9871 ){
                                printf("L3 = %d ", L3[i-4319][m] - 1);
                                printf("comput[%d] = %d ", L3[i-4319][m] - 1,comput[L3[i-4319][m] - 1]);
                            }*/
                ...
                //for (i = 0; i < rc; i++) printf("%d", comput2[i]);
                // to check Hx=0     
                for (i = 0; i < rc; i++) {
                    checkbit[i] = 0;
                    if (i < (rc/2)) {
